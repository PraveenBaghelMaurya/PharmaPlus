...
function App() {
  ...
  const [stripeApiKey, setStripeApiKey] = useState("pk_test_51P6c0ySAZqlbTJQWIv4ZuJ3LEIfYaHUNG8urj3nTYlpEFgnQvixzSZ36JAdQ8hWkb425pHknBDk9XVqUVIG3rl9n006HZY8Q6z");

  // async function getStripeApiKey() {
  //   const { data } = await axios.get("/api/v1/stripeapikey");

  //   setStripeApiKey(data.stripeApiKey);
  //   console.log(`this is the stripe api key : `,data.stripeApiKey)
  // }
